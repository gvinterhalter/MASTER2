...
transkribuju se u funkcionlane RNK molekule dok gore pomenuti \keyword{kodirajući geni}
...
tzv. \keyword{pp lanac} ili \keyword{kičmu peptida} sa koje štrče bočni nizovi.
...
\begin{itemize}
  ...
  \item \keyword{$\beta$-traka}  - predstavlja spoj dva ili više (anti)paralelnih delova polipeptidnog lanca.
\end{itemize}
