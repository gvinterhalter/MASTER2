...
Računska analiza implementirana je u jeziku pajton \en{Python} verzija 3.6.
...
Novi rezultati za predviđene \keyword{uređene} MF ključne reči globalno se
...
Predviđene \keyword{neuređene} MF ključne reči imaju znatno više razlika u
