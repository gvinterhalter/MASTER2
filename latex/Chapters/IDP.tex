...
plesni \parencite{dunker2001}.} analogija o \keyword{bravi i ključu}, koju su ponovo 
otkrila nezavisna istraživanja Hsien Wu,  Mirski i Paulinga 
postavila je temelje opšteprihvaćene
paradigme \keyword{struktura-funkcija} \parencite{dunker2001}.
...
Prvi kontraprimer navedene teorije javio se još 1950. Protein krvne plazme,
...
\keyword{teorija indukovanog fita}\footnote{Teorija indukovanog fita omekšava
...
\en{induced-fit theory} dominirale su krajem prošlog veka, zanemarujući
...
\begin{enumerate}
  \item \keyword{Uređen protein} - analogno čvrstom stanju materije u prirodi

  \item \keyword{Topljiva globula} \en{molten globule} - analogno tečnom stanju materije u prirodi
  ...
  \item \keyword{Nasumično klupko} \en{random coil} - analogno gasovitom stanju materije u prirodi
\end{enumerate}
...
ali funkcionalne regione skraćeno označavamo \keyword{IDPr}
...
\begin{itemize}
  ...
  \item
    ...
    informacije poistovećena sa brojem bitova potrebnih za njeno kodiranje).}
...
prediktora druge generacije zasnovanih na veštačkim neuronskim mrežama, u nastavku
