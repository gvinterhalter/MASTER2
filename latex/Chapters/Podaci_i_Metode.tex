...
\keyword{Svis-Prot}\ref{svis-prot} \en{Swiss-Prot}, verzija 48 iz 2005.
...
proteina u \keyword{proteinske familije} dobivši 27.217 familija. Svaki protein
onda ima težinu kojom doprinosi daljoj analizi. Težina svakog proteina je onda
u kontekstu klastera inverzno proporcionalna veličini klastera kome pripada
tako da je zbir težina svih proteina jednog klastera jednak jedan. 
...
\begin{enumerate}
  ...
  \item \file{uniprot\_sprot\_exp.txt} pridružuje funkcije u obliku 
    \keyword{GO termini}. Zastupljeni su termini iz sva tri imenska prostora:
...
Ova vrsta znanja nije bila dostupna 2006. a ni danas situacija nije mnogo bolja.
...
\begin{itemize}
  \item Broj eksperimentalno određenih neuređenih regiona je veoma mali.
    ...
    Najveću pouzdanost nose regioni koji su eksperimentlano utvrđeni sa što
...
izjednačavamo uzročnost \en{causation} i \keyword{korelaciju}. Ali prvo
