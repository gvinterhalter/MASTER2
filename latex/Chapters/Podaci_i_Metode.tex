...
\keyword{CAFA3}. Trening skupovi su podaci na osnovu kojih prediktor uči, pa
...
\begin{itemize}
  \item \file{keywlist.txt}\cite{keywlist_txt} verzija 20.12.2017 sadrži
    ...
    više GO termina.
  \item \file{uniprotkb\_kw2go}\cite{uniprotkb_kw2go} sadrži samo
...
\textbf{Ograničenost} današnjih podataka i razvijenih metoda:
\begin{itemize}
...
$1/20$. U statistici ovo je još poznato kao model jednakih verovatnoća \en{equiprobable model}.  Drugi
