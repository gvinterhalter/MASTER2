...
(
  ...
  FOREIGN KEY (start_id) REFERENCES goterms (id) ON DELETE CASCADE,
  FOREIGN KEY (end_id) REFERENCES goterms (id) ON DELETE CASCADE
);
...
(
  ...
  FOREIGN KEY (parent) REFERENCES keywords (ac) ON DELETE CASCADE
);
...
(
  ...
  PRIMARY KEY (kw, go),
  FOREIGN KEY (kw) REFERENCES keywords (ac) ON DELETE CASCADE,
  FOREIGN KEY (go) REFERENCES goterms (id) ON DELETE CASCADE
);
...
(
  ...
  PRIMARY KEY (kw, prot),
  FOREIGN KEY (kw) REFERENCES keywords (ac) ON DELETE CASCADE,
  FOREIGN KEY (prot) REFERENCES valid_proteins (ac) ON DELETE CASCADE
);
